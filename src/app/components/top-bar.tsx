...
export function TopBar() {
  ...
  return (
    <header className="public-topbar sticky top-0 z-40 w-full max-w-[100vw] overflow-hidden border-b border-[var(--border)] bg-[var(--bg)]/88 backdrop-blur-xl backdrop-saturate-150">
