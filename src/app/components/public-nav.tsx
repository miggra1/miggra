  ...
  return (
    <nav className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-4 px-6 py-6 text-white/80 lg:px-10">
      ...
      <div className="flex flex-wrap gap-3 text-sm">
        <Link href="/notes" prefetch={false} className="rounded-full border border-white/10 bg-white/5 px-4 py-2 transition hover:bg-white/10">
          归档
        </Link>
        <Link href="/admin" prefetch={false} className="rounded-full border border-white/10 bg-white/5 px-4 py-2 transition hover:bg-white/10">
          后台
        </Link>
