...
async function main() {
  ...
  await prisma.contentItem.createMany({
    data: [
      ...
      { section: "READING", title: "《毛泽东传》", detail: "从人物经历和时代背景里看历史叙事的复杂性。", status: "已读完", order: 1 },
      { section: "READING", title: "《三体》", detail: "在宏大设定和人类处境之间来回拉扯，适合慢慢读。", status: "在读", order: 2 },
      { section: "READING", title: "《三体》相关延伸阅读", detail: "如果想继续了解世界观和科幻写作，可以顺着再读一些分析和访谈。", status: "想读", order: 3 },
